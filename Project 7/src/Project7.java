...
public class Project7 
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		while (continuePlaying.equalsIgnoreCase("yes"))
		{
			...
			String scrambledWord = randomizedWord(word);
	
			int numGuesses = timesGuessed(keyboard, word, scrambledWord);
			...
			showPoints(wordPoints, pointsEarned, word); 
	...
	public static String randomizedWord(String word) throws FileNotFoundException {
	...
	public static int timesGuessed(Scanner keyboard, String word, String scrambledWord) throws FileNotFoundException {
	...
	public static void showPoints(int wordPoints, int pointsEarned, String word) throws FileNotFoundException {
